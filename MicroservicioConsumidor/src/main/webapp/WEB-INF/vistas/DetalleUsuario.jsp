...
<head>
	...
	<title>spring-microservicios: Detalle de Usuario</title>
</head>
...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div style="text-align: right">[ <a href="<c:url value='/'/>">Página Principal</a>
              | <a href="ListaUsuarios">Usuarios</a> ]</div>
		</div>
