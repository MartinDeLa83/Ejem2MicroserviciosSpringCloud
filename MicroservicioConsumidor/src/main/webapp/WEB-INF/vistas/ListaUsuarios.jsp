...
<head>
	...
	<title>spring-microservicios: Lista de Usuarios</title>
</head>
...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div style="text-align: right">[ <a href="/">Página Principal</a> ]</div>
		</div>
		...
		<div class="row">
			...
			<ul>
				<c:forEach items="${usuarios}" var="usuario">
					<li><a href="DetalleUsuario?id=${usuario.id}">${usuario.nombre}</a></li>
				</c:forEach>
			</ul>
